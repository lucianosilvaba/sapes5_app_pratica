		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App de pratica Odata Sapes5",
									"targetURL": "#brcompraticasapes5apppratica-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcompraticasapes5apppratica-display": {
								"semanticObject": "brcompraticasapes5apppratica",
								"action": "display",
								"description": "Aplicativo para pratica com Odata SAPES5",
								"title": "App de pratica Odata Sapes5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.pratica.sapes5apppratica",
									"url": sap.ui.require.toUrl("br/com/pratica/sapes5apppratica")
								}
							}
						}
					}
